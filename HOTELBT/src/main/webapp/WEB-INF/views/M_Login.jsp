						...
						<form action="M_login" method="POST" enctype="multipart/form-data">
							<div class="form-group form-inline">
								<div class="form-group col-lg-6 col-md-12 name">
									<input type="text" name="MId" class="form-control"  placeholder="ID" onfocus="this.placeholder = ''" onblur="this.placeholder = 'ID'">
								</div>
								
							</div>
							 <div class="form-group col-lg-6 col-md-12 name" >
								<input type="password" class="form-control" name="MPw" placeholder="PW" onfocus="this.placeholder = ''" onblur="this.placeholder = 'PW'">
							</div> 
							<br>
							...
							<br/>
							<input type="submit" value="login" class="genric-btn primary small">
						</form>
					</div>
