	...
	<section class="whole-wrap">
		<div class="container">
			<div class="section-top-border">
				<h3 class="mb-30">문의작성</h3>
				<div class="progress-table-wrap">
					<div class="progress-table">

	
	<form action="Q_write" method="POST" enctype="multipart/form-data">
	<table>
			<caption>문의 작성</caption>
		<tr>
			<th>작성자</th>
			<td>${sessionScope.loginId}
			<input type="hidden" name="QId" value="${sessionScope.loginId}"></td>
		</tr>
		<tr>
			<th>제목</th>
		...
		<tr>
			<th>내용</th>
			<td><textarea rows="20" cols="40" name="QContent"></textarea></td>
		</tr>
