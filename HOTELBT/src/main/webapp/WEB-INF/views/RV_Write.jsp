	...
	<section class="whole-wrap">
		<div class="container">
			<div class="section-top-border">
				<h3 class="mb-30">후기내용</h3>
				<div class="progress-table-wrap">
					<div class="progress-table">

						<form action="RV_write" method="POST" enctype="multipart/form-data">
	<table>
		<tr>
			<th>작성자</th>
			<td>${sessionScope.loginId}
			<input type="hidden" name="REId" value="${sessionScope.loginId}"></td>
		</tr>
		<tr>
			<th>제목</th>
		...
		<tr>
			<th>내용</th>
			<td><textarea rows="20" cols="40" name="REContent"></textarea></td>
		</tr>
		
		<tr>
			<th>첨부파일</th>
			<td><input type="file" name="REFile"></td>
		</tr>
