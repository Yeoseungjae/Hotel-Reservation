		...
		<div class="container">
			<div class="row justify-content-between align-items-center text-center banner-content">
				<div class="col-lg-12">
					...
					<p>품격이 다른 편안함으로 당신의 휴식을 책임집니다.</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="whole-wrap">
		<div class="container">
			<div class="section-top-border">
				<h3 class="mb-30">Life Style</h3>
				<div class="progress-table-wrap">
					<div class="progress-table">
						<div class="table-head">
							<div class="serial" style="width:20%">이름</div>
							<div class="country" style="width:50%">사진</div>
							<div class="visit" style="width:30%">내용</div>
						</div>
						<c:forEach var="list" items="${aroundList}">
						<div class="table-row">
							<div class="serial" style="width:20%">${list.AName}</div>
							<div class="country" style="width:50%"> <img src="resources/img/${list.AFileName}" width="400px"></div>
							<div class="visit" style="width:30%">${list.AContent}</div>
						</div>
						</c:forEach>
					</div>
				</div>
